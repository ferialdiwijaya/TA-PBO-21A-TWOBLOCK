...
<head>
  <title>Online Class MANSAPES</title>
  <meta charset="UTF-8">
...
<body>
  ...
  <div class="limiter">
    <div class="container-login100" style="background-image: url('vendor/login/images/bg-login.jpg');">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
        <center><img src="vendor/images/LOGO1.png" class="animated-logo" alt="" height="120" width="140"></center>


        <form method="post" action="" class="login100-form validate-form">
          <span class="login100-form-title p-b-20">
            ONLINE CLASS <br> MAN 1 PESAWARAN
          </span>
          ...
          <div class="wrap-input100 validate-input" data-validate="Password is required">
            ...
            <select name="level" class="form-control" required style="background-color: #13801c;border-radius: 7px;color: #fff;font-weight: bold;">
